...
\begin{document}
	...
	\part{Análisis con Recolección de datos vía URLs de Properati}
	
		Insertar breve intro
		...
		\section{Análisis de Cuartos por Propiedad}
			...
			Insertar texto acá				
				...
				\begin{figure}
    				\centering
    				\makebox[\textwidth]{\includegraphics[width=\textwidth]{images/RelHabPrec}}
    				\caption{CABA + GBA}
				\end{figure}
				
				\begin{figure}
    				\centering
    				\makebox[\textwidth]{\includegraphics[width=\textwidth]{images/RelHabSup}}
    				\caption{CABA + GBA}
				\end{figure}
		...
		\section{Análisis de Ambientes por Propiedad}
			...
			Insertar texto acá				
				...
				\begin{figure}
    				\centering
    				\makebox[\textwidth]{\includegraphics[width=\textwidth]{images/RelAmbPrec}}
    				\caption{CABA + GBA}
				\end{figure}
				
				\begin{figure}
    				\centering
    				\makebox[\textwidth]{\includegraphics[width=\textwidth]{images/RelAmbSup}}
    				\caption{CABA + GBA}
				\end{figure}
